            ...
            <div class="question">
                ...
                <div class="question-answer">
                    <div>
                        ...
                        <label for="radio_1" class="radio"><span>Erkek</span></label>
                    </div>
                    <div>
                        <input type="radio" value="none" id="radio_2" name="info" />
                        <label for="radio_2" class="radio"><span>Kadın</span></label>
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <select>
                    ...
                    <option value="b">Yazılım Mimarileri</option>
                    <option value="ch">Web Programlama</option>
                    <option value="v">Sunucu İşletim Sistemleri</option>
                </select>
            </div>
            <div class="item">
                <label for="note">Notunuz<span>*</span></label>
