...
<body>
    ...
    $x = (-4);
    $mutlak = abs($x);
    echo "|$x|'ün mutlak değeri: $mutlak";


    echo "<h5>Taban Değişim İşlemi(base_convert(x,taban1,taban2))</h5>";
    echo "27 saysının 2'lik tabandaki karşılığı:" . base_convert(27, 10, 2);
    echo "<br>";
    $sayi = 50;
    $taban = 10;
    $yenitaban = 2;
    ...
    /* Her zaman en yakın aşağı tam sayı değerine yuvarlama işlemi yapılır. */
    $x = 15.315;
    echo "$x : " . floor($x);


    echo "<h5>Yuvarlama İşlemi(ceil(x)</h5>";
    /* Her zaman en yakın yukarı tam sayı değerine yuvarlama işlemi yapılır. */
    $x = 15.315;
    echo "$x : " . ceil($x);
